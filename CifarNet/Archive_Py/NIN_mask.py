...
from CifarNet_mask import ReLuConvLayer, MaxPoolingLayer, FCSoftMaxLayer, FCLayer, SoftMaxLayer, IdenConvLayer
from CifarNet_mask import load_data, compression_API, eval_accuracy, eval_adversarial_efforts, eval_contractive_term
    ...
    def train(self, n_epochs):
        ...
        while (epoch < n_epochs) and (not done_looping):
            ...
            for minibatch_index in range(self.n_train_batches):
                ...
                # print("layer in")
                ##print(self.test_grads_to_params(0)[0])
                # print("layer out")
...
if __name__ == '__main__':
    ...
    folders = [
        ['NIN_NO_REGULAR_KEEPBIAS', 'no_regular', 'SW', ''],
        ['NIN_LOGINIT_NO_REGULAR_KEEPBIAS', 'no_regular', 'SW', '']
    ]
    ...
    # nn = NINNet(cf_type='no_regular', initial_learning_rate=0.005)
