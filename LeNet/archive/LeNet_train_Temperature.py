...
class FCSoftMaxLayer(object):
    ...
    def __init__(self, input, n_in, n_out, rng=None, temperature= 1):
        ...
        self.p_y_given_x_notemperature = T.nnet.softmax(T.dot(input, self.W) + self.b)
...
if __name__ == '__main__':
    ...
    nn = LeNet(n_epochs=40,temperature=10)
    params = nn.train()
    f = open('./weight/normal_weights_RandInit_Temperature10.pkl', 'wb')
